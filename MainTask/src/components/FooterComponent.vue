<template>
    <footer class="amazing-footer">
      <div class="footer-content">
        ...
        <div class="footer-section">
          <h4>Contact Info</h4>
          <p><i class="fas fa-map-marker-alt"></i> 123 Sesame Street, Elmos', World</p>
          <p><i class="fas fa-phone"></i> 69696969</p>
          <p><i class="fas fa-envelope"></i> contactmyas@zinger4life.com</p>
        </div>
      </div>
